...
public class CreateJobWithDBValidationWithResponseModelTest {
	private CreateJobPayload createJobPayload;
	private Customer customer;
	private CustomerAddress customerAddress;
	CustomerProduct customerProduct;
	private JobService jobService;
	@BeforeMethod(description="Creating createjob api request payload,instantiating the job service")
	public void setup(){
		...
		customerProduct=new CustomerProduct(getTimeWithDaysAgo(10),"98881664997158","98881664997158","98881664997158",getTimeWithDaysAgo(10),Product.NEXUS_2.getCode(),Model.NEXUS_2_BLUE.getCode());
	...
	public void createJobAPITest(){
		...
		CustomerProductDBModel customerProductDBData=CustomerProductDao.getProductInfoFromDB(customerId);
