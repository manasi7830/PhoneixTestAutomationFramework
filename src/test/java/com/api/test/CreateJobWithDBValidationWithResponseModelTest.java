...
public class CreateJobWithDBValidationWithResponseModelTest {
	...
	public void setup(){
		...
		customerProduct=new CustomerProduct(getTimeWithDaysAgo(10),"98881664997157","98881664997157","98881664997157",getTimeWithDaysAgo(10),Product.NEXUS_2.getCode(),Model.NEXUS_2_BLUE.getCode());
