...
public class CreateJobBeanMapper {
	...
	@Step("Converting the CreateJobBean to the CreateJobPayload for CreateJobAPI")
	public static CreateJobPayload mapper(CreateJobBean bean) {
		...
		CreateJobPayload payload=new CreateJobPayload(mstServiceLocationId, mstPlatformId, mstWarrentyStatusId, mstOemId,
				customer, 
				customerAddress, 
				customerProduct, 
				problemList);
