...
public class MapJobProblemDao {
	...
	@Step("Retriving the problem details information from DB for the specific jobhead id")
	public static MapJobProblemModel getProblemDetails(int tr_job_head_id) {
		...
		try {
			...
			LOGGER.error("Cannot convert the result sey to the mapJobProblemModel bean", e);
